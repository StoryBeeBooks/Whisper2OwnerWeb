...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'subscribe.policyNotice': 'By visiting this website and subscribe to our newsletter, you acknowledge and agree to our',
  ...
  zh: {
    ...
    'subscribe.policyNotice': '访问本网站并订阅我们的新闻通讯即表示您确认并同意我们的',
